...
- Bumped `pyTigerGraph` dependency from `>=2.0.1` to `>=2.0.2`.
...
- Initial release of `pyTigerGraph-mcp` as a standalone MCP server package (previously bundled in `pyTigerGraph`).
