"""Tests for tigergraph_mcp.tools.gsql_tools."""
...
from tigergraph_mcp.tools.gsql_tools import get_llm_config, gsql

PATCH_TARGET = "tigergraph_mcp.tools.gsql_tools.get_connection"
